...
public class LikedPostPager extends Fragment {


    ArrayList<Post> arrayList=new ArrayList<>();
    RecyclerView recyclerView;
    String id;
    public LikedPostPager(String id) {
        this.id=id;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View  v= inflater.inflate(R.layout.fragment_liked_post_pager, container, false);

        recyclerView=v.findViewById(R.id.postlikeadapter);
    ...
    public void Refresh(String id) {
        ...
        Call<PostResult> call=apIinterface.postlistlike(id);
