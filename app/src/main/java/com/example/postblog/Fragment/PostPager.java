...
public class PostPager extends Fragment {

    ArrayList<Post>arrayList=new ArrayList<>();
    RecyclerView recyclerView;
    String id;
    public PostPager(String id) {
        this.id=id;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_post_pager, container, false);
        recyclerView=v.findViewById(R.id.postadapter);
    ...
    public void Refresh(String id) {
        ...
        Call<PostResult> call=apIinterface.postlist(id);
